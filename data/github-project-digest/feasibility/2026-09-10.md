...
> 输入：今日锚点 `daily/2026-09-07.md`（5 个项目）；组合池：最近 90 天（2026-06-12 ~ 2026-09-10）314 个唯一项目（日报 61 份 / 周报 10 份）。方案 1-3 个，取决于当日锚点能命中几个组合模板。
...
**可行性依据**：全部组件来自今日日报，能力面尽量互补（4 个），无需等待固定模板命中即可拼出组合。 本组合含今日发现项目 5 个（`openwhispr/openwhispr`、`lnkiai/m3e-canvas`、`zjunlp/lightmem`、`openai/openai-cli`、`aipoch/open-science`）；池中各能力面候选充足（agent 282 · rag 89 · local 164 · observability 121），最稀缺槽位也有 89 个候选。
