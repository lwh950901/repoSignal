...
## 一、Agent 运行、训练与治理
### 1. DeepSeek Harness
**介绍：** [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) 是面向开发者的 Agent Harness，以 Cordis 插件架构组织 Web、模型、工具和运行时能力，并提供 Web 与命令行入口。
...
### 2. Agent Lightning
**介绍：** [Agent Lightning](https://github.com/microsoft/agent-lightning) 是面向 Agent 研究与工程团队的可插拔训练、优化和评测运行时，提供从轨迹数据到训练闭环的示例管线。
...
**介绍：** [Agent Governance Toolkit](https://github.com/microsoft/agent-governance-toolkit) 是面向多语言 Agent 应用的工具调用治理工具包，在调用前提供策略、身份、沙箱、审批和审计能力。
...
### 4. Herdr
**介绍：** [Herdr](https://github.com/herdrdev/herdr) 是面向编码 Agent 用户的 Rust Runtime/TUI，让多个持久终端会话可观察、可恢复并支持并行工作。
...
### 5. Google ADK Go
**介绍：** [Google ADK Go](https://github.com/google/adk-go) 是 Google 面向 Go 团队的 code-first Agent Development Kit，用于构建、评测、编排并部署云原生 Agent。
...
## 二、开发交付与受控自动化
### 6. Archify
**介绍：** [Archify](https://github.com/tt-a1i/archify) 是面向开发者与团队的 Agent Skill，把代码库或系统描述转换为可验证、可分享的架构、流程、时序和数据流图。
...
### 7. Playwright MCP
**介绍：** [Playwright MCP](https://github.com/microsoft/playwright-mcp) 是面向 Agent 的浏览器自动化 MCP 服务，将 Playwright 操作与结构化可访问性树结合，用于网页操作、测试和采集。
...
### 8. OpenMontage
**介绍：** [OpenMontage](https://github.com/calesthio/OpenMontage) 是面向内容创作者与内容团队的 Agent 视频生产系统，将研究、脚本、素材、剪辑和合成组织成多阶段管线。
...
## 三、真实个人流程与持续学习
### 9. AI Job Search
**介绍：** [AI Job Search](https://github.com/MadsLorentzen/ai-job-search) 是面向个人求职者的本机 AI 求职申请框架，通过多阶段工作流搜索职位、评估匹配度、定制简历与求职信并准备面试材料。
...
**介绍：** [AI Engineering from Scratch](https://github.com/rohitg00/ai-engineering-from-scratch) 是内容型课程与教程合集，按二十个阶段组织 AI、LLM、Agent 和生产工程学习，并要求通过运行、测试和 artifact 保留学习证据。
...
**阅读全文：** [2026-W35 完整周报](/weekly/2026-W35/)
